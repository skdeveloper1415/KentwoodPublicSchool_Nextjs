...
import {fetchFreshmen_on_Track_Popup_dimension} from "../../redux/slices/Indicatorpopup"
import LoaderContainer from "../LoaderContainer";
import { ChartSplitLine, FormatNum } from "../utils";

export default function FreshmanonTrack(props) {
    ...
    /* redux state */
    const Freshmen_on_Track_Popup_dimensionloading = useSelector(state => state.indicatorpopup.Freshmen_on_Track_Popup_dimensionloading)
    const Freshmen_on_Track_Popup_dimension = useSelector(state => state.indicatorpopup.Freshmen_on_Track_Popup_dimension)
    /* */
    ...
    useEffect(()=>{
        if(selectedDimension && visible){
            dispatch(fetchFreshmen_on_Track_Popup_dimension({
            "elasticQueryName": "",
    ...
    const ChartData = useMemo(()=>{
        let SplitLine;
        let Labels = []
        let data = Freshmen_on_Track_Popup_dimension.reduce((acc,item)=>{
                ...
                <Dialog header="Header"
                    ...
                    <div>
                        ...
                        <div className="brand-neutral-50 flex items-center 2xl:gap-[0.833vw] gap-4   2xl:h-[3.125vw] h-[65px] xl:h-[55px]">
                            ...
                            <div className=" font-normal leading-6 2xl:leading-[1.219vw] flex items-center 2xl:gap-[0.417vw] gap-1">
                                <div className="feedback-isSuccess 2xl:text-[0.833vw] text-sm"><i className="ru-dots"></i></div>
                                <div className="white_text_color text-[16px] xl:text-[0.885vw] text-base font-normal leading-6 2xl:leading-[1.25vw]"><p>Freshman on Track
                                </p></div>
                            </div>
                        </div>
                        <ScrollPanel className="h-[600px] 2xl:h-[31.25vw] xl:h-[28.25vw] 3xl:h-[31.25vw] w-full custm_ScrollPanel">
                            <div className="bg_blue_color_900 2xl:p-[1.25vw] p-5 2xl:space-y-[1.25vw] space-y-[20px]">
                                ...
                                <div>
                                    <ChartWrapper
                                        formatDownloadedData={Freshmen_on_Track_Popup_dimension}
                                        formatFileName={"Freshman on Track"}
                                        ExportIcon={true}
                                        titleshow={true}
                                        title={"Freshman on Track Students Passing Grade 9 "}
                                        data={
                                            <>
                                                <div>
                                                    <div className="bg-[#1F2A37] 2xl:rounded-[0.313vw] flex items-center rounded 2xl:p-[0.417vw] p-1.5 2xl:mt-[0.417vw] mt-1.5">
                                                        {/* <div className="flex items-center 2xl:gap-[0.25vw] gap-5">
                                                            ...
                                                            <div>
                                                                ...
                                                                className="w-full md:w-[309px] 2xl:w-[18.229vw] 2xl:h-[1.51vw] h-[24px] custom_Dropdown"
                                                    ...
                                                    <div className="h-[155px] xl:h-[21.185vw] 2xl:h-[17.385vw] 3xl:h-[15.385vw] max-md:w-[1000px]">
                                                        <LoaderContainer height={'100%'} loading={Freshmen_on_Track_Popup_dimensionloading}>
                                                        <Barlinechart
                                                            legends={{
                                                                show:false,
                                                                left: 10,
                                                            ...
                                                            //     values: ["100", "98", "96", "97", "98"],
                                                            //     values2: ["90", "90", "90", "90", "90"],
                                                            // }}
                                                            data={{
                                                                labels: ChartData.Label,
                                                                values2: ChartData.data?.["TOTAL_STUDENTS"],
                                                                values: ChartData.data?.["PER_ON_TRACK"],
                                                            }}
                                                    ...
                                                    <div className="flex items-center gap-[8px] ml-[12px] text-[#E5E7EB] text-[14px] 2xl:text-[14px] xl:text-[12px] 3xl:text-[0.729vw] font-normal">
                                                        ...
                                                        Students passing represent those who moved onto grade 10 after successful completion of grade 9 in the prior school year.</div>
                                                </div>
                                            </>
                                        }
                                    />

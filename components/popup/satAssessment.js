...
import {fetchSAT_Assessment_Popup_dimension} from "../../redux/slices/Indicatorpopup"
import LoaderContainer from "../LoaderContainer";
import { ChartSplitLine, FormatNum } from "../utils";

export default function SatAssessment(props) {
    ...
    /* redux state */
    const SAT_Assessment_Popup_dimensionloading = useSelector(state => state.indicatorpopup.SAT_Assessment_Popup_dimensionloading)
    const SAT_Assessment_Popup_dimension = useSelector(state => state.indicatorpopup.SAT_Assessment_Popup_dimension)
    /* */
    ...
    if(selectedDimension && visible){
        dispatch(fetchSAT_Assessment_Popup_dimension({
        "elasticQueryName": "",
    ...
    const ChartData = useMemo(() => {
        let SplitLine;
        let Labels = []
        let data = SAT_Assessment_Popup_dimension.reduce((acc, item) => {
        ...
        return { data: data, Label: Labels, ChartSplitLine: ChartSplitLine({y: SplitLine, yFormatter: params => `Statewide Average: ${FormatNum(params.value, 1)}`})}
    ...
    console.log("Excel Data",SAT_Assessment_Popup_dimension)
    const SAT_Assessment_Popup_dimensionExcelData = SAT_Assessment_Popup_dimension?.map((item) => {
    return {
      "Student_Group": item["STUDENT_GROUP"],
      "AVERAGE_SAT_SCORE": item["AVERAGE_SAT_SCORE"],
                    ...
                    <div>
                        ...
                        <div className="brand-neutral-50 flex items-center 2xl:gap-[0.833vw] gap-4 2xl:h-[3.125vw] h-[65px] xl:h-[55px] ">
                            ...
                            <div className="2xl:text-[0.938vw] font-normal leading-6 2xl:leading-[1.219vw] flex items-center 2xl:gap-[0.417vw] gap-1">
                                ...
                                <div className="white_text_color text-[16px] xl:text-[0.885vw] text-base font-normal leading-6 2xl:leading-[1.25vw]"><p>SAT Assessment
                                </p></div>
                            </div>
                        </div>
                        <ScrollPanel  className="h-[600px] 2xl:h-[31.25vw] xl:h-[28.25vw] 3xl:h-[31.25vw] w-full custm_ScrollPanel">
                            <div className="bg_blue_color_900 2xl:p-[1.25vw] p-5 2xl:space-y-[1.25vw] space-y-[20px]">
                                    ...
                                    <div className="bg-[rgba(0,0,0,0.35)] 2xl:rounded-[0.417vw] rounded-xl 2xl:p-[0.833vw] p-3.5">
                                        <div className="grid grid-cols-12 2xl:gap-[0.833vw] gap-3">
                                            <div className="col-span-9 2xl:space-y-[0.833vw] space-y-[14px]">
                                                <div>
                                                    <div className="text-[#9CA1AB] 2xl:text-[0.729vw] font-normal leading-5 2xl:leading-[1.042vw] mb-2">
                                                    Number of SAT Application
                                                    </div>
                                                    <div className="text-[#FFFFFF] 2xl:text-[0.938vw] font-medium leading-3 2xl:leading-[1.25vw]">
                                                    Rejected in Current Year
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-span-3">
                                ...
                                <div>
                                    <ChartWrapper
                                        formatDownloadedData={SAT_Assessment_Popup_dimensionExcelData}
                                        formatFileName={"SAT Assessment"}
                                        ExportIcon={true}
                                        titleshow={true}
                                        title={"SAT Assessment Total Score "}
                                        data={
                                            <>
                                                <div>
                                                    ...
                                                    {/* <div className="h-[155px] xl:h-[21.185vw] 2xl:h-[17.385vw] 3xl:h-[15.385vw]">
                                                        ...
                                                        legends={{
                                                           ...
                                                           grid={{
                                                            ...
                                                            lineName1="Average"
                                                            barName="No. of Students "
                                                            barWidth={65}
                                                            barcolor={"#EDC948"}
                                                            colors={['#F8826B']}
                                                            data={{
                                                                labels: ["Asian", "Black or AA", "Hispanic", "Two or More", "White"],
                                                                values: ["100", "98", "97", "98", "98"],
                                                                values2: ["90", "90", "90", "90", "90"],
                                                            }}
                                                            xAxisName={"Ethnicity"}
                                                            xAxisNameGap={"30"}
                                                     ...
                                                     <div className="h-[255px] xl:h-[21.185vw] 2xl:h-[17.385vw] 3xl:h-[15.385vw] max-md:w-[1000px]">
                                                        <LoaderContainer height={'100%'}loading={SAT_Assessment_Popup_dimensionloading}>
                                                        <Barlinechart
                                                            legends={{
                                                                show:false,
                                                                left: 10,
                                                            ...
                                                            // Name1={"No. of Students"}
                                                            Name1={"Graduation Rate"}
                                                            barcolor={"#B7E1CD"}
                                                            colors={['#E6DE32']}
                                                            // data={{
                                                            //     labels: ["Asian", "Black or AA", "Hispanic", "Two or More", "White"],
                                                            //     values: ["904", "1098", "1145", "910", "1251"],
                                                            //     values2: ["1000", "1000", "1000", "1000", "1000"],
                                                            // }}
                                                            data={{
                                                                labels: ChartData.Label,
                                                                values: ChartData.data?.["AVERAGE_SAT_SCORE"],
                                                                // values: ChartData.data?.["SPED_SAT_Score"],
                                                            }}
                                                            xAxisName={selectedDimension.name}
                                                            xAxisNameGap={"30"}
                                                            xAxisNamePosition={"center"}
                                                            // yAxisName={"No. of Students"}
                                                            yAxisName={"Total Score (Average)"}
                                                            yAxisNameGap={"50"}
                                                            yAxisNamePosition={"middle"}
                                                            xaxisLabel={{
                                                                interval: 0,
